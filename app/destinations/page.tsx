    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <header className="mb-8 text-center">
          <h1 className="text-balance text-3xl font-semibold text-gray-900 sm:text-4xl">Explore Destinations</h1>
          <p className="mt-2 text-gray-600">Discover iconic places around the world and plan your next trip.</p>
        </header>
